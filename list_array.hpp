...
#pragma region constructors
        ...
        /**
         * @brief Constructor for the `list_array` class that takes an initializer list of a different type or same type as input.
         *
...
#pragma region push
        ...
        */
        ...
        /**
        * @brief Adds a copy of the value to the end of the arrays.
        *
        * @param value The value to be added.
        */
        template <class AnotherT>
        ...
        /**
        * @brief Adds a copy of the value to the beginning of the arrays.
        *
        * @param value The value to be added.
        */
        template <class AnotherT>
        ...
        *
        * @param value The value to be added.
        * @return list_array<T, Allocator> A new list_array with the last element placed.
        */
...
#pragma region index and iterators
        ...
        /**
         * @brief Compares elements in array and returns true if arrays is different
         *
         * @tparam AnyAllocator The allocator type of the other `list_array`.
         * @param other The second array to compare
        ...
        /**
         * @brief Compares elements in array using `FN` function and returns true if arrays is different
         *
         * @tparam AnyAllocator The allocator type of the other `list_array`.
         * @param other The second array to compare
         * @return Comparaison result, true if not equal
...
public:
    ...
    /**
     * @brief Pushes a specified number of bits from a value of any integral type to the end of the array.
     *
     * @tparam U The type of the value to push.
     * @param value The value containing the bits to push.
     * @param num_bits The number of bits to push from the value.
     * @return A reference to the modified bit_list_array.
     */
    ...
    /**
     * @brief Pushes a specified number of bits from a value of any integral type to the front of the array.
     *
     * @tparam U The type of the value to push.
     * @param value The value containing the bits to push.
     * @param num_bits The number of bits to push from the value.
    ...
    /**
     * @brief Gets a specified number of bits from a given position and returns them in a value of any integral type.
     *
     * @tparam U The type of the value to return.
     * @param pos The starting bit position.
     * @param num_bits The number of bits to retrieve.
     * @return The value containing the retrieved bits.
     */
    ...
    /**
     * @brief Sets a specified number of bits at a given position from a value of any integral type.
     *
     * @tparam U The type of the value to set.
     * @param pos The starting bit position.
     * @param value The value containing the bits to set.
     * @param num_bits The number of bits to set from the value.
     */
    template <std::integral U>
